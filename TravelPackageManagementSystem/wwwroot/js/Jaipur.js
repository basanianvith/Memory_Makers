// Repurposed JS for Jaipur page (wwwroot/js/Jaipur.js)
// Mirrors Manali behaviour: gallery, lightbox, itinerary accordion, pricing and simple form validation
// Adjusted base price / taxes for Jaipur package
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Pricing calculation based on guests (Jaipur package)
    ...
    function updatePrice() {
        ...
        if (pricePerPersonElm) pricePerPersonElm.textContent = `₹${basePrice.toLocaleString('en-IN')} / person`;
        if (totalPayableElm) totalPayableElm.textContent = `₹${total.toLocaleString('en-IN')}`;
