// Repurposed JS for Manali page (placed in wwwroot/js/Mizoram.js)
// Updated base price/taxes to match Manali package
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Pricing calculation based on guests (Manali package)
